...
export default function AboutUs() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* 3. CON SỐ ẤN TƯỢNG (Chuyển sang nền tối cho sang trọng) */}
      ...
      {/* 4. TẦM NHÌN - SỨ MỆNH - GIÁ TRỊ CỐT LÕI (Dạng Card Nổi Bật) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-t-4 border-yellow-500">
              ...
              <p className="text-gray-600 leading-relaxed">
                Trở thành đơn vị phân phối và phát triển bất động sản uy tín hàng đầu, là biểu tượng của sự đẳng cấp và là lựa chọn số 1 của khách hàng thượng lưu.
              </p>
            </motion.div>

            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} transition={{ delay: 0.2 }} className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-t-4 border-blue-600">
              ...
              <p className="text-gray-600 leading-relaxed">
                Cung cấp các giải pháp an cư và đầu tư thông minh, minh bạch pháp lý, góp phần nâng tầm chuẩn mực sống và kiến tạo cộng đồng tinh hoa.
              </p>
            </motion.div>

            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} transition={{ delay: 0.4 }} className="bg-white p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-t-4 border-green-600">
              ...
              <p className="text-gray-600 leading-relaxed">
                <strong className="text-gray-900">Tâm - Tầm - Tín.</strong> Làm việc bằng cái tâm, nhìn bằng cái tầm chiến lược và giữ trọn chữ tín với mọi khách hàng.
              </p>
            </motion.div>
          </div>
        </div>
